    ...
    <div className='pb-14 px-8 md:px-0'>
      ...
      <div className='grid grid-cols-3 gap-8 mt-14'>
        {dummyTestimonial.map((testimonials,index)=> (
          <div className='text-sm text-left border border-gray-500/30 shadow-[0px_4px_15px_0px] shadow-black/5 rounded-lg pb-6 bg-white overflow-hidden'
          key={index}>
            ...
            <div className='p-5 pb-7'>
                <div className='flex gap-0.5'>
                  {[...Array(5)].map((_,i)=> (
                    <img key={i} src={i < Math.floor(testimonials.rating) ? assets.star : assets.star_blank} alt="star_icon" className='w-3.5 h-5' />
                  ))}
                </div>
