...
const Dashboard = () => {
  ...
  return dashboardData ? (
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 mb:pb-0 p-4 pt-8 pb-0'>
          ...
          <table className='table-fixed md:table-auto w-full overflow-hidden'>
            ...
            <tbody className='text-gray-500 text-sm'>
              {dashboardData.enrolledStudentsData.map((item, index) => (
                <tr key={index} className='border-b border-gray-500/20 hover:bg-gray-300'>
